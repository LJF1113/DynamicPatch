...
class RealIADDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.source = source # ./datasets/Real-IAD/realiad_256
        self.json_path = json_path # ./datasets/Real-IAD/realiad_jsons_fuiad_0.4
        self.split = split
        self.classnames_to_use = [classname] if classname is not None else _CLASSNAMES
        self.train_val_split = train_val_split # 1.0 (all train)
    ...
    def get_image_data(self):
        ...
        for classname in self.classnames_to_use:
            # print(classname)
            json_file = self.json_path +'/'+classname+'.json'
        ...
        #             data_to_iterate.append(data_tuple)
            for data in data_list:
                ...
                anomaly = data['anomaly_class']
                img_path = data['image_path']
                img_path = os.path.join(self.source,classname,img_path)
                data_tuple = [classname,anomaly,img_path]
                if self.split == DatasetSplit.TEST and anomaly != self.normal_class:
                    mask_path = data['mask_path']
                    mask_path = os.path.join(self.source,classname,mask_path)
