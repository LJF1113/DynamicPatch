...
class DynamicPatch_Online_Base(torch.nn.Module):
    def __init__(self, device):
        super(DynamicPatch_Online_Base, self).__init__()
        self.device = device
                ...
                for image in data_iterator:
                    ...
                    if len(features) == bank_shape:
                        ...
                        with torch.no_grad():
                            ...
                            norm_features = bank_features#[24*8*784*thres,1024]
                            ...
                            if not init_flag:
                                ...
                                # torch.save(sample_features,'./norm_features.pth')
    ...
    def _predict(self, images):
        ...
        with torch.no_grad():
            ...
            patch_scores = image_scores * weight
